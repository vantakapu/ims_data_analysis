...
if __name__ == '__main__':
    ...
    df_clustered = cluster_analysis(find_peaks, max_distance=3)
    df_clustered
    
    # Save the resulting DataFrame to an Excel file
    df_clustered.to_excel('final_cluster_3.xlsx', index=False)
    ...
    cluster_result = process_and_save_clustered_data(df_clustered)
    cluster_result
